...
public class Program
{
    ...
    private static List<XlsxToLua.FileInformation> existExcelFilePaths = new List<XlsxToLua.FileInformation>();

    private static List<string> existExcelFileNames = new List<string>();
    ...
    private static void Main(string[] args)
    {
        ...
        for (int i = 4; i < args.Length; ++i)
        {
            ...
            // 另外还需将-exportCsClass的判断放到-exportCsv之前
        ...
        #endregion 如果声明要额外导出为csv文件的Excel表本身在本次被忽略，需要进行警告
        ...
        #endregion 如果声明要额外导出为json文件的Excel表本身在本次被忽略，需要进行警告
        ...
        #endregion 读取给定的Excel所在目录下的所有Excel文件，然后解析成本工具所需的数据结构
        ...
        if (isTableAllRight == true)
        {
            ...
            foreach (string tableName in AppValues.ExportTableNames)
            {
                ...
                #endregion 额外导出csv文件、csv对应C#类文件、json文件
            }
        ...
        #endregion 进行表格导出，检查通过则导出，否则提示错误位置
    ...
    private static void chek5(string[] args, string param)
    {
        ...
        // value = value.Trim();
        // if (string.IsNullOrEmpty(value))
        // Utils.LogWarning(string.Format("警告：声明的{0}参数下属的参数{1}所配置的导出csv对应C#类的类名前缀为空，若不想设置，可以直接不配置此参数，而不是将参数值留空", AppValues.EXPORT_CS_CLASS_PARAM_PARAM_STRING, AppValues.EXPORT_CS_CLASS_PARAM_NAMESPACE_PARAM_STRING));
        // else
        // AppValues.ExportCsvClassClassNamePrefix = value;
        // }
        // else if (AppValues.EXPORT_CS_CLASS_PARAM_USING_PARAM_STRING.Equals(key, StringComparison.CurrentCultureIgnoreCase))
        ...
        // value = value.Trim();
        // if (string.IsNullOrEmpty(value))
        // Utils.LogWarning(string.Format("警告：声明的{0}参数下属的参数{1}所配置的导出csv对应C#类的类名后缀为空，若不想设置，可以直接不配置此参数，而不是将参数值留空", AppValues.EXPORT_CS_CLASS_PARAM_PARAM_STRING, AppValues.EXPORT_CS_CLASS_PARAM_USING_PARAM_STRING));
        // else
        // AppValues.ExportCsvClassClassNamePostfix = value;
        // }
        // else if (AppValues.EXPORT_JAVA_CLASS_PARAM_EXPORT_PATH_PARAM_STRING.Equals(key, StringComparison.CurrentCultureIgnoreCase))
        // {
        // value = value.Trim();
        // if (string.IsNullOrEmpty(value))
        // Utils.LogWarning(string.Format("警告：声明的{0}参数下属的参数{1}所配置的导出csv对应C#类文件中的命名空间为空，若不想设置命名空间，可以直接不配置此参数，而不是将参数值留空", AppValues.EXPORT_CS_CLASS_PARAM_PARAM_STRING, AppValues.EXPORT_JAVA_CLASS_PARAM_EXPORT_PATH_PARAM_STRING));
        // else
        // AppValues.ExportCsvClassClassNamePrefix = value;
        // }
        // else if (AppValues.EXPORT_JAVA_CLASS_PARAM_PACKAGE_PARAM_STRING.Equals(key, StringComparison.CurrentCultureIgnoreCase))
        ...
        // value = value.Trim();
        // if (string.IsNullOrEmpty(value))
        // Utils.LogWarning(string.Format("警告：声明的{0}参数下属的参数{1}所配置的导出csv对应C#类文件中的引用类库为空，若不想设置引用类库，可以直接不配置此参数，而不是将参数值留空", AppValues.EXPORT_CS_CLASS_PARAM_PARAM_STRING, AppValues.EXPORT_JAVA_CLASS_PARAM_PACKAGE_PARAM_STRING));
        // else
        // {
        // // 通过英文逗号分隔各个引用类库
        // string[] usingList = value.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        // AppValues.ExportCsClassUsing = exportCsvClassUsing;
        // else
        // Utils.LogWarning(string.Format("警告：声明的{0}参数下属的参数{1}所配置的导出csv对应C#类文件中的引用类库均为空，若不想设置引用类库，可以直接不配置此参数，而不是将参数值留空", AppValues.EXPORT_CS_CLASS_PARAM_PARAM_STRING, AppValues.EXPORT_JAVA_CLASS_PARAM_PACKAGE_PARAM_STRING));
        // }
        // }
        // }
        // else
